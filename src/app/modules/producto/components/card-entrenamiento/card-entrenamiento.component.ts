...
@Component({
  ...
  templateUrl: './card-entrenamiento.component.html',
  styleUrls: ['./card-entrenamiento.component.css']
})
export class CardEntrenamientoComponent {
  // Colección de todos los productos de forma local
  coleccionProductos: Producto[] = [];

  // Colección de productos de una sola categoría
  coleccionEntrenamiento: Producto[] = [];
